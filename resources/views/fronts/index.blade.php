...
@section('content')
    ...
    <div class="space-medium">
        <div class="container-fluit portfolio">
            ...
            <div class="container-fluit container-fluit-color">
                <div class="container">
                    <h1 class="txt-wel2 p-c text-center text-gray">OUR ROOMS</h1>
                    <div class="row">
                        @foreach($rooms as $r)
                        <div class="col-lg-4 col-sm-6 portfolio-item">
                            <div class="card card-c flat h-100">
            ...
            <?php $special_offers = DB::table('special_offers')->where('active', 1)->orderBy('id', 'desc')->limit(1)->get();?>
            @foreach($special_offers as $special)
                <div class="special_offer">
                    <img src="{{asset('uploads/special-offers/'.$special->featured_image)}}" alt="" width="100%">
                    <div class="odiv">
                        <h1 class="otitle">
                            {{$special->title}}
                        </h1>
                        <h4 class="odescription">{{$special->description}}</h4>
                        <a class="btn btn-info btn-cicle" href="{{$special->url}}">Offer Details</a>
                    </div>
                </div>
            @endforeach
                ...
                <div class="col-md-12">
                    <div class="row">
                        <div class="col-md-12 text-center">
                            <p class="txt-wel2 p-c text-gray"> HOTEL'S LOCATION</p>
                        </div>
                    </div>
                </div>
