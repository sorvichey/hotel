...
// special offer 
Route::get('/admin/special-offer', "SpecialOfferController@index");
Route::get('/admin/special-offer/create', "SpecialOfferController@create");
Route::post('/admin/special-offer/save', "SpecialOfferController@save");
Route::get('/admin/special-offer/edit/{id}', "SpecialOfferController@edit");
Route::post('/admin/special-offer/update', "SpecialOfferController@update");
Route::get('/admin/special-offer/delete/{id}', "SpecialOfferController@delete");
// offer 
