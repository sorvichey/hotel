        ...
        <div class="sidebar">
            <nav class="sidebar-nav">
                <ul class="nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{url('/admin/offer')}}"><i class="fa fa-percent text-info"></i> Offer Page</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{url('/admin/special-offer')}}"><i class="fa fa-percent text-danger"></i>Special Offer </a>
                    </li>
                    <li class="nav-item">
